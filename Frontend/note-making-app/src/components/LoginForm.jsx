...
function LoginForm() {
  const {loginVal,handleSubmit,updateLoginForm,message } = useCustomLoginHook();
...
/*
  <div>
      <form onSubmit={handleSubmit}>
        <input onChange={updateLoginForm} type="email" value={loginVal.email}  name="email" />
        <input onChange={updateLoginForm} type="password" value={loginVal.password} name='password' />
